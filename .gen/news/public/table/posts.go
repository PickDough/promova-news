...
func newPostsTableImpl(schemaName, tableName, alias string) postsTable {
	var (
		...
		allColumns      = postgres.ColumnList{IDColumn, TitleColumn, ContentColumn, CreatedAtColumn, UpdatedAtColumn}
		mutableColumns  = postgres.ColumnList{TitleColumn, ContentColumn, CreatedAtColumn, UpdatedAtColumn}
	)
